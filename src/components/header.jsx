            ...
            <div className="navbar-nav-scroll">
                <ul className="navbar-nav bd-navbar-nav flex-row">
                    <li className="nav-item">
                        ...
                        {/* <a className="nav-link " href="/" onClick={eval("ga('send', 'event', 'Navbar', 'Community links', 'Bootstrap')")}>Home</a> */}
                    </li>
                    <li className="nav-item">
                        {/* <a className="nav-link " href="http://getbootstrap.com/docs/4.1/getting-started/introduction/" onClick={eval("ga('send', 'event', 'Navbar', 'Community links', 'Docs');")}>Documentation</a> */}
                        <NavLink className="nav-link" to="/docs">Documentation</NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink className="nav-link" to="/examples">Examples</NavLink>
                        {/* <a className="nav-link active" href="/examples/" onClick={eval("ga('send', 'event', 'Navbar', 'Community links', 'Examples');")}>Examples</a> */}
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="https://themes.getbootstrap.com" onClick={eval("ga('send', 'event', 'Navbar', 'Community links', 'Themes');")} target="_blank" rel="noopener">Themes</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="https://expo.getbootstrap.com" onClick={eval("ga('send', 'event', 'Navbar', 'Community links', 'Expo');")} target="_blank" rel="noopener">Expo</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="https://blog.getbootstrap.com" onClick={eval("ga('send', 'event', 'Navbar', 'Community links', 'Blog');")} target="_blank" rel="noopener">Blog</a>
                    </li>
                </ul>
            </div>
            ...
            <ul className="navbar-nav flex-row ml-md-auto d-none d-md-flex">
                <li className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu dropdown-menu-right" aria-labelledby="bd-versions">
                        <a className="dropdown-item active" href="/docs/4.1/">Latest (4.1.x)</a>
                ...
                <li className="nav-item">
                    <a className="nav-link p-2" href="https://twitter.com/getbootstrap" target="_blank" rel="noopener" aria-label="Twitter">
                        <svg className="navbar-nav-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 416.32" focusable="false">
                            <title>Twitter</title>
